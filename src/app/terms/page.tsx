    ...
    <ProfileLayout template={template}>
      <div className="flex flex-col min-h-full">
        ...
        <div className="rounded-2xl p-4 w-full max-w-sm mx-auto bg-white/80">
          ...
          >
            <section>
              ...
              <p>
                本規約は、平成プロフィール（以下「本サービス」）の利用に関する条件を定めるものです。ユーザーは本規約に同意の上、本サービスを利用するものとします。
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-0.5">
                <li>本サービスは「現状のまま」提供され、特定目的への適合性を保証しません</li>
                <li>ユーザー間のトラブルについて運営者は責任を負いません</li>
                <li>データの消失・破損について運営者は責任を負いません</li>
                <li>本サービスの利用により生じた損害について運営者は責任を負いません</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                本規約に関するお問い合わせは、X（Twitter）アカウント {CONTACT_SNS} までご連絡ください。
              </p>
            </section>

            <p className="text-center mt-4" style={{ color: template.primaryColor }}>
              運営者: {OPERATOR_NAME}
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-auto px-6 pb-4">
          <Link
            href="/"
            className="text-xs underline mb-2 inline-block"
